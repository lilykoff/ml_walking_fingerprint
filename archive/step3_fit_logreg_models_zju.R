...
saveRDS(all_predictions_zju_s1, "all_predictions_zju_logreg_s1.rds")
...
saveRDS(all_predictions_zju_s2, file = "~/Documents/ml_walking_fingerprint/Results/all_predictions_zju_logreg_s2.rds")
...
saveRDS(all_predictions_zju_all, file = "~/Documents/ml_walking_fingerprint/Results/all_predictions_zju_logreg_all.rds")
...
saveRDS(all_predictions_zju_s1s2, file = "~/Documents/ml_walking_fingerprint/Results/all_predictions_zju_logreg_s1s2.rds")
